import { Modal, Button, Heading, Tabs, Tag } from "@navikt/ds-react";
...
interface AdapterComponentData {
  adapterId: string;
  username: string;
  orgId: string;
...
interface AdapterComponentModalProps {
  isOpen: boolean;
  onClose: () => void;
  data: AdapterComponentData | null;
  adapterName: string;
}
                    ...
                    {data.capabilities.map((capability, index) => (
                      <div key={index} className="border rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            <span className="font-medium text-gray-600">Delta Sync Intervall:</span>
